...
class EDAPipeline():
    ...
    def read_data(self, path, version="../data"):
        try:
            repo = "/home//Desktop/10-academy/week-9/Logistic-optimization-Causal-Inference"
    ...
    def calculate_distances(self, starting_coordinates, ending_coordinates):
        ...
        for i in range(len(starting_coordinates)):
            ...
            if val_end[0] == "0.0" or val_end[1] == "0.0":
                ...
                calculated_distances.append(distance.distance(starting_tuple, ending_tuple).km)  # type: ignore
